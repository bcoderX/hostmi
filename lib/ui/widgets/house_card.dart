...
class _HouseCardState extends State<HouseCard> {
            ...
            children: [
              ClipRRect(
                ...
                child: Stack(children: [
                  GestureDetector(
                    onTap: () async => _onDetailsClick(context),
                            ...
                            if (isConnected) {
                              if (isLoggedIn) {
                                ...
                                if (isAlreadyAdded.isNotEmpty) {
                                  ...
                                  getFavoriteStatus(widget.house.id!)
                                      .then((value) {
                                    setState(() {
                                      isFav = value;
                                    });
                    ...
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(
                          ...
                          shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(10.0))),
                      onPressed: () async => _onDetailsClick(context),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            widget.house.latitude == 0 ||
                                    widget.house.longitude == 0
                                ? const SizedBox()
                                : const Icon(
                                    Icons.location_on,
                                    color: Colors.red,
                      ...
                      children: [
                        ...
                        FutureBuilder(
                          ...
                          builder: (context, snapshot) {
                            ...
                            if (snapshot.hasData) {
                              return Text(int.parse(snapshot.data.toString())
                                  .numeral());
                            }
                            return const Text("--");
                          },
  ...
  void _onDetailsClick(BuildContext context) async {
    ...
    if (isConnected) {
      if (isLoggedIn) {
        ...
        bool isAlreadyAdded =
            await selectViewsWithNullUser(houseId: widget.house.id!);
        if (isAlreadyAdded) {
