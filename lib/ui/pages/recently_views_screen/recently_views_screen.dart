...
class RecentlyViewsScreen extends StatelessWidget {
  const RecentlyViewsScreen({super.key});
    ...
    return SafeArea(
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                centerTitle: true,
                title: AppbarSubtitle(text: "Recently Viewed")),
            body: SizedBox(
                width: size.width,
                            ...
                            Padding(
                                ...
                                child: Row(children: [
                                  ...
                                  Padding(
                                      ...
                                      child: Text("St. Celina, Delaware 10299",
                                          overflow: TextOverflow.ellipsis,
                                          textAlign: TextAlign.left,
