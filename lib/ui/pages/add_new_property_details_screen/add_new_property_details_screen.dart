...
class AddNewPropertyDetailsScreen extends StatelessWidget {
  const AddNewPropertyDetailsScreen({super.key});
  @override
                                                                          ...
                                                                          child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.end, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                            ...
                                                                            Container(
                                                                                ...
                                                                                child: Stack(alignment: Alignment.bottomCenter, children: [
                                                                                  Align(alignment: Alignment.centerRight, child: Padding(padding: getPadding(right: 3), child: SizedBox(height: getVerticalSize(48), child: VerticalDivider(width: getHorizontalSize(1), thickness: getVerticalSize(1), color: ColorConstant.brown500)))),
                                                                                  Align(alignment: Alignment.bottomCenter, child: Container(height: getSize(8), width: getSize(8), decoration: BoxDecoration(color: ColorConstant.blueGray50, borderRadius: BorderRadius.circular(getHorizontalSize(4)), border: Border.all(color: ColorConstant.brown500, width: getHorizontalSize(2)))))
                                                                                ]))
                                                                          ])))
                                                            ])),
                                                    Padding(
