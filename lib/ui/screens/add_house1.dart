...
import 'package:hostmi/ui/screens/add_house2.dart';
            ...
            children: [
              ...
              LabeledDropdownField(
                ...
                items: [
                  DropdownMenuItem<String>(
                      value: AppLocalizations.of(context)!.singleHouse,
                      child: Text(AppLocalizations.of(context)!.singleHouse)),
                  DropdownMenuItem<String>(
                      value: AppLocalizations.of(context)!.commonHouse,
                      child: Text(AppLocalizations.of(context)!.commonHouse)),
                ],
              ...
              LabeledDropdownField(
                ...
                items: [
                  ...
                  DropdownMenuItem<String>(
                      value: "officials",
                      child: Text(AppLocalizations.of(context)!.officials)),
                  DropdownMenuItem<String>(
                      value: "intern",
                      child: Text(AppLocalizations.of(context)!.interns)),
                  DropdownMenuItem<String>(
                      value: "students",
                  ...
                  DropdownMenuItem<String>(
                      value: "buisnessman",
                      child:
                          Text(AppLocalizations.of(context)!.businessOwners)),
                ],
                onChanged: (String? value) {},
              ),
              _spacer,
              ...
              LabeledDropdownField(
                ...
                items: [
                  ...
                  DropdownMenuItem<String>(
                      value: "single",
                      child: Text(AppLocalizations.of(context)!.single)),
                  DropdownMenuItem<String>(
                      value: ",married",
                      child: Text(AppLocalizations.of(context)!.couple)),
                ],
                onChanged: (String? value) {},
              ),
              _spacer,
