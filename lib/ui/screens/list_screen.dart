      ...
      child: Stack(
        children: [
          Scaffold(
                        ...
                        Semantics(
                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              child:
                                  const Icon(Icons.tune, color: AppColor.white),
                            ),
                          ),
                        ),
                      ],
                  ...
                  SizedBox(
                    ...
                    child: Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(
                              left: 8.0, top: 8.0, bottom: 15.0, right: 10),
                          child: Text(
                        ...
                        GestureDetector(
                          ...
                          child: Padding(
                            ...
                            child: Icon(
                              ...
                              color: _showFilters ? null : AppColor.primary,
                            ),
                          ),
                        ),
                      ],
            ...
            floatingActionButton: getData(keyAgencyDetails)==null ? FloatingActionButton(
                  ...
                  child: Wrap(
                    ...
                    children: context
                        ...
                        .map((feature) => OptionsItemWidget(
                              amenity: feature,
                              selected:
                                  selectedFeatures.map((e) => e.id!).toList(),
                  ...
                  child: Wrap(
                    ...
                    children: context
                        ...
                        .map((houseType) => OptionsItemWidget(
                              amenity: houseType,
                              selected:
                                  selectedHouseType.map((e) => e.id).toList(),
                  ...
                  onValidate: () {
                    ...
                    setState(() {
                      ...
                      context.read<HostmiProvider>().filterForm.currency =
                          selectedCurrency;
                      context.read<HostmiProvider>().filterForm.priceType =
                          selectedPriceType;
                      // context.read<HostmiProvider>().filterForm.types = [
                      //   ...selectedHouseType
                      // ];
          ...
          _showCountries
              ? FilterStack(
                  ...
                  child: CustomDropDown<Country>(
                      value: context.read<HostmiProvider>().filterForm.country,
                      //focusNode: FocusNode(),
                      icon: Container(
                          margin: getMargin(left: 30, right: 16),
                          child: CustomImageView(
